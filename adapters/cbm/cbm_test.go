...
//
// Everything that claims to exercise CBM runs against a real
// codebase-memory-mcp >=0.10.1 and the graphs testdata/prepare-fixture.sh built
// from the versioned demo repository. There is no fake CBM here: a mock would
// only prove that the adapter agrees with our own idea of CBM.
package cbm_test
